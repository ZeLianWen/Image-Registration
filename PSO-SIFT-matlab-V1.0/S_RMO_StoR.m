function [S,RMO,delat_x,delat_y,scale_hist,scale_x,angle_hist,...
    angle_x,x_hist,x_x,y_hist,y_x]=S_RMO_StoR(cor1,cor2,unit_scale,unit_angle,unit_x,unit_y)
...
if(strcmp(smooth,'true'))
    ...
    index_scale=index_scale+0.5*(scale_hist(k1)-scale_hist(k2))/...
        (scale_hist(k1)+scale_hist(k2)-2*scale_hist(index_scale)+10^-5);
end
...
if(strcmp(smooth,'true'))
    ...
    index_angle=index_angle+0.5*(angle_hist(k1)-angle_hist(k2))/...
        (angle_hist(k1)+angle_hist(k2)-2*angle_hist(index_angle)+10^-5);
end
...
if(strcmp(smooth,'true'))
    ...
    index_x=index_x+0.5*(x_hist(k1)-x_hist(k2))/...
        (x_hist(k1)+x_hist(k2)-2*x_hist(index_x)+10^-5);
end
...
if(strcmp(smooth,'true'))
    ...
    index_y=index_y+0.5*(y_hist(k1)-y_hist(k2))/...
        (y_hist(k1)+y_hist(k2)-2*y_hist(index_y)+10^-5);
end
